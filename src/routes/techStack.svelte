		...
		<div class="bg-slate-950">
			<div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
				<div class="grid grid-cols-4 gap-8 md:grid-cols-6 lg:grid-cols-8">
					...
					<Icon name="Pinecone" linkURL="https://pinecone.io" imgURL="https://yepcode.io/docs/img/integrations/icons/pinecone.svg" />
					...
					<Icon name="Cloudinary" linkURL="https://cloudinary.com/" imgURL="cloudinary.png" />
					<Icon name="Replicate" linkURL="https://replicate.com" imgURL="replicate.jpg" />
