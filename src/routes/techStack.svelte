...
<div class="bg-slate-950 py-8" id="skills">
	<div class="">
		...
		<div class="bg-slate-950">
			<div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
				<div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-8">
					...
					<Icon linkURL="https://firebase.google.com/" imgURL="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain.svg" />
					<Icon linkURL="https://www.postgresql.org/" imgURL="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" />
