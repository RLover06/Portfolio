<script>
	...
	const technologies = [
		...
		},
		{
			...
			imgURL: "https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/12_Algolia_logo_logos-512.png"
		},
		{
...
<div class="pt-4 pb-1 mt-44" id="tech">
	<div class="">
		<h2 class="text-3xl font-bold tracking-tight text-center sm:text-4xl bg-gradient-to-r text-indigo-300 glow space-grotesk">
			Technologies Used
		</h2>
