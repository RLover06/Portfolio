...
>
	<div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
		...
		<div class="mt-10 max-w-2xl text-lg font-medium">
			<div>
				<p>
					I am a huge fan of <span class="font-bold text-black text-lg">TypeScript. </span>The tooling is impressive, but what really stands out about TypeScript is how it encourages me to be more mindful of the code I write.
				...
				<p class="mt-6">
					...
					<br /><br />
					<!-- <span class="text-indigo-600 font-bold italic space-grotesk"
						>Currently - B2
