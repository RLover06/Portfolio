	...
	<div class="pt-12 sm:pt-16 lg:pt-20">
		<div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				<h2
					class="text-3xl leading-9 font-extrabold sm:text-4xl sm:leading-10 lg:text-5xl lg:leading-none text-indigo-300 glow space-grotesk"
				>
					Contact
				</h2>
		...
		<div class="relative">
			...
			<div class="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
				<div class="max-w-lg mx-auto rounded-lg glow-box">
					<div
						class=" bg-gradient-to-b from-neutral-100 to-neutral-300 px-6 py-8 lg:flex-shrink-1 lg:p-12 rounded-lg hover:outline-dotted hover:outline-4 outline-indigo-400 outline-offset-4"
					>
						<h3
							class="text-2xl leading-8 font-extrabold text-gray-900 sm:text-3xl sm:leading-9 text-center"
						>
						...
						<div class="mt-8">
							<div class="flex items-center">
								<h4
									class="flex-shrink-0 pr-4 text-sm leading-5 tracking-wider font-semibold uppercase text-indigo-600"
								>
									Available for:
								</h4>
							...
							<ul class="mt-8 grid grid-cols-2 col-gap-8 row-gap-5 lg:gap-y-6">
								{#each positions as position}
									<li class="mt-5 flex items-start lg:col-span-1 lg:mt-0">
										...
										<p class="ml-3 text-sm leading-5 text-gray-700">{position.name}</p>
									</li>
								{/each}
							</ul>
						</div>
